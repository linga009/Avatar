...
**Goal:** Replace Avatar's hand-tuned psyche with Critical Order-Parameter Cognition — emotions, curiosity, and consciousness derived from phase-diagram geometry of a self-organizing Kuramoto system.

**Architecture:** New `cop.py` module computes (r, chi, tau, unity) each tick. Emotions derived from manifold position instead of if/elif tree. SOC controller dynamically adjusts Kuramoto coupling K. Existing psyche modules rewritten internally but keep identical output interfaces — zero downstream breakage.
...
|------|--------|---------------|
| `halo3/psyche/cop.py` | CREATE | COP engine: chi, tau, SOC controller, unity index, emotion manifold |
| `halo3/kuramoto.py` | MODIFY | Add `cluster_coherence_matrix()` and `unity_index()` pure functions |
...
| `halo3/main.py` | MODIFY | 1 line: coupling_mod becomes absolute K |
...
### Task 1: Add COP Config Parameters
...
### Task 2: Add Coherence Matrix and Unity Index to kuramoto.py
...
### Task 3: Create COP Engine (cop.py)
...
### Task 4: Rewrite emotions.py with COP Manifold
...
### Task 5: Modify drives.py — Curiosity = chi
...
### Task 6: Rewrite introspection.py — Self-Surprise from tau
...
### Task 7: Rewrite workspace.py — Ignition from chi Geometry
...
### Task 8: Modify temporal.py — tau Replaces emotion_coherence
...
### Task 9: Rewrite meditation.py — K-Control Mechanism
...
### Task 10: Rewrite organism.py — Wire COP Engine
...
### Task 11: Modify main.py — Absolute K from coupling_mod
...
### Task 12: Update Existing Tests and Run Full Suite
...
### Task 13: Enhanced Logging and Validation
...
### Task 14: Final Integration Test and Docker Build Verification
