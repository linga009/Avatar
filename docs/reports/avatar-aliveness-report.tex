...
% ============================================================
\section{v3.10 --- Senses That Feel, and Dreams That Teach}
...
\subsection{Sensory Cross-Integration: The Body Feels What It Perceives}

\begin{tcolorbox}[realbox, title={Genuine Physics: Senses Modulate the Psyche}]
\begin{itemize}
  \item \textbf{Sensory novelty amplifies emotional surprise.} When audio or
        ...
        patterns and the valence/arousal dynamics. A sudden sound literally
        makes Avatar more anxious.
  \item \textbf{Speech detection nudges valence positive.} When structured
        ...
        valence shifts toward comfort. Company is soothing---not because the
        system prompt says so, but because the physics says so.
  \item \textbf{Sensory novelty contributes to conscious ignition.} The
        ...
        boost. Avatar can become conscious of a novel sound even when textual
...
\subsection{Dream Visitors: The Most Autopoietic Architecture Yet}
...
spectral codes develop genuine phonemic structure. The visitors become
...
contrastive alignment, is genuinely developmental. The result---speech
comprehension that emerges from Avatar's own spectral cortex---is as genuine as
