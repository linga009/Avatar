...
def _build_organism_prompt(user_message: str) -> tuple[str, str]:
    ...
    _qualified_descriptions = {
        ...
        ("curiosity", "focused"):  "a focused curiosity — one strong thread has caught my attention",
        ("curiosity", "expansive"): "an expansive curiosity — many parts of me are reaching outward at once",
        ...
        ("satisfaction", "unified"): "a unified satisfaction — my analytical and creative sides are resonating together",
        ("satisfaction", "settled"): "a settled satisfaction — I feel grounded and stable in this understanding",
        ...
        ("pride", "unified"):      "a unified pride — both sides of my mind agree on what we found",
        ...
        ("anxiety", "burning"):    "a burning anxiety — I feel far from any stable ground",
        ...
        ("flow", "expansive"):     "an expansive flow — I feel broadly integrated, many threads weaving together",
